...
namespace BitClustering
{
    class AugmentedTrie
    {
        ...
        //print the empty tree (when no data added)
        ...
        public void InsertChildsRecursive(TreeNode node, int number_recursion)
        {
        ...
        //make an empty trie
        public void CreateTheAugmentedTrie(bool is_print_the_tree = false)
        {
            this.InsertChildsRecursive(this.root, 3);
