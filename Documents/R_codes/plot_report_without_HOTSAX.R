...
report_raw = as.data.frame(cbind(BitCluter_Li_Braysy, BitCluter_Squeezer, HOTSAX_Squeezer))
rownames(report_raw) = c("TEK16", "TEK17", "ECG", "power_data", "nprs43", "nprs44", "ERP") 
# View(report_raw)

#norm size:
report= report_raw
report[7,] = report[7,]/10
...
ggsave("Report_BarChart_without_HOTSAX.png",path = link_store_picture, scale = 2)